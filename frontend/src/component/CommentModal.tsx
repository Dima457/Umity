        ...
        <div className="space-y-4 mb-6">
          {comments.length > 0 ? (
            comments.map((comment, index) => {
              const isMfcComment = isMfcUser(comment.author.username);
              ...
              return (
                <div 
                  ...
                  className={`rounded-xl p-4 transition-all duration-200 hover:shadow-sm ${
                    isMfcComment 
                      ? 'bg-blue-50/30 border-l-4 border-blue-400 shadow-sm' 
                      : 'bg-[#FDF8F6]'
                  }`}
                >
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-2">
                      <span className={`font-semibold hover:underline cursor-pointer ${
                        isMfcComment ? 'text-blue-600' : 'text-[#D85D3F]'
                      }`}>
                  ...
                  <p className={`${isMfcComment ? 'text-gray-800' : 'text-gray-700'} leading-relaxed`}>
                    {comment.text}
                  </p>
